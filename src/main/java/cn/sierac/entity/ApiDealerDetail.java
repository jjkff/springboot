...
public class ApiDealerDetail {
    ...
    private List<ApiDealerData> dataList;
    ...
    public List<ApiDealerData> getDataList() {
        return dataList;
    }

    public void setDataList(List<ApiDealerData> dataList) {
