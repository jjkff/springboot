 ...
 */
public class DealerMoveHeader {
    public DealerMoveHeader(){
    }
    ...
    private List<DealerMoveDetail> detailList;
    ...
    public void setDetailList(List<DealerMoveDetail> detailList) {
    ...
    public List<DealerMoveDetail> getDetailList() {
        return detailList;
    }
}
