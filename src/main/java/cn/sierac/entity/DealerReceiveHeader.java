 ...
 */
public class DealerReceiveHeader {
    public DealerReceiveHeader(){
    }
    ...
    private List<DealerReceiveDetail> detailList;
    ...
    public List<DealerReceiveDetail> getDetailList() {
        return detailList;
    }
    ...
    public void setDetailList(List<DealerReceiveDetail> detailList) {
